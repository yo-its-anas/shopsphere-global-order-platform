...
The realm JSON uses Keycloak's native environment-variable placeholder resolution for frontend redirect and origin values. It creates no human users and contains no passwords or client secrets. It defines the confidential customer activity reader without embedding its generated credential. Version-controlled client-policy documents provide explicit S256 PKCE enforcement and are reconciled idempotently after startup import.
