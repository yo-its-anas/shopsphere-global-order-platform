...
from app.core.errors import AuthenticationError, IdentityProviderUnavailableError
...
class Principal:
    ...
    def has_any_role(self, *roles: Role) -> bool:
        return bool(self.roles.intersection(role.value for role in roles))
...
class KeycloakTokenVerifier:
    """Verify RS256 access tokens against asynchronously refreshed Keycloak JWKS."""
